...
@Entity
/**
 * A CategoryMember is an element that belongs to a CategoryMembers object. In
 * MediaWiki, it can be a category or an article or whatever media
 *
 * Extend this class to have a specific entity and table for your batch data
 */
